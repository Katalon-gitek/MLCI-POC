...
import javax.xml.ws.WebEndpoint as WebEndpoint
...
java.util.List row = tableCAM.findElements(By.tagName('tr'))

String expected = 'I - 13762208002'
...
WebUI.click(findTestObject('CAMPage/CAMDetailPage/Menu_Report_CAM'))

WebUI.click(findTestObject('CAMPage/CAMDetailPage/SubMenu_Report_CAM_2'))

WebUI.click(findTestObject('CAMPage/CAMDetailPage/SubMenu_Attachment_CAM'))
